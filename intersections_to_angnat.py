...
df5 = pd.read_csv('MZ81_sle_protein_peptide_superdex75_2.csv', sep = ';')
df5 = df5.filter(['Protein Accession', 'Peptide']).drop_duplicates()
...
res1 = df5.merge(df4, how = 'inner', on = 'Peptide', indicator = True)
res1 = res1.filter(['Protein Accession'])
res1 = res1.rename(columns = {'Protein Accession' : 'protein'})
res2 = df5.merge(df8, how = 'inner', on = 'Peptide', indicator = True)
